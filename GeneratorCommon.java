...
//        dsc.setDriverName("com.mysql.jdbc.Driver");
        ...
        dsc.setPassword("Gouqichun5254");
        dsc.setUrl("jdbc:mysql://localhost:3306/expresssystem");
        ...
        strategy.setInclude(new String[]{"user"}); // 需要生成的表.如果需要生成所有的, 注释掉此行就可以
